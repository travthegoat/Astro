...
const AddPostHome = () => {
    return (
        <div className="w-full h-24 bg-[#0b0b0b] border border-neutral-900 lg:rounded-lg flex items-center px-8 gap-5">
            ...
            <button className="rounded-full bg-neutral-900 text-neutral-500 h-12 w-full px-2 lg:px-4 text-lg xl:text-xl text-start pb-1 hover:bg-neutral-800 cursor-pointer duration-75">
